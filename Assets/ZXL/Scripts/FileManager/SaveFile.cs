...
public class SaveFile : MonoBehaviour
{
    ...
    public void LoadByJson()
    {
        ...
        else
        {
            ...
            FileData data = JsonMapper.ToObject<FileData>(jsonStr);//using LitJson;
    ...
    private void LoadGame(FileData data)
    {
        ...
        {
            PlayerSaveFileController.Instance.GetComponent<PlayerFileManager>().LoadPlayerFile(data.playerFile);
        }
